...
// ACTION - Xử lý các hành động (tạo mới, cập nhật, xóa)
...
export default function QRCodeForm() {
  ...
  // Chọn sản phẩm từ Shopify Resource Picker
